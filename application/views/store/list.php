          ...
          <article class="col-main">
              ...
              <ol class="products-list" id="products-list">
                <li class="item">
                  ...
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product-detail.html" title="Product tilte is here">Product tilte is here</a></h2>
                ...
                <li class="item">
                  <div class="product-image"> <a href="product-detail.html" title="Product tilte is here"> <img class="small-image" src="images/products/product-fashion-1.jpg" alt="Product tilte is here"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product-detail.html" title="Product tilte is here">Product tilte is here</a></h2>
                    <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
                    <div class="desc std">
            ...
            <div class="toolbar bottom">
              <div class="row">
                ...
                <div class="col-sm-6 text-right">Showing 1 to 8 of 25 (2 Pages)</div>
              </div>
            </div>
          </article>
        </div>