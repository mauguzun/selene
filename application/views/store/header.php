...
<!-- CSS Style -->
<link rel="stylesheet" type="text/css" href="<?= base_url()?>/static/css/styles.css" media="all">
</head>
...
<div id="jtv-mobile-menu">
  ...
  <div class="top-links">
    <ul class="links">
      ...
      <li class="last"><a title="Login" href="<?= base_url().'/auth'?>"><span><?= lang('login')?></span></a></li>
    </ul>
              ...
              <div class="top_section hidden-xs">
                <div class="toplinks">
                  ...
                  <ul class="links">
                    ...
                    <li><a title="Log In" href="<?= base_url().'auth/login'?>">Log In</a></li>
                  </ul>
                </div>
              </div>
            </div>
