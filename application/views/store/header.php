...
<head>
	...
	<!-- Document Title -->
	<title>
	 	<?= strip_tags($meta['title']) ?>
	</title>
	<meta  name="description" content="<?= strip_tags($meta['description'])?>"/>
	<meta  name="keywords" content="<?=strip_tags( $meta['keywords'])?>"/>
...
<div class="logo logo-fly"   tabindex='1' >
	<span id="cart_total" class="cart-num"><?= $total ?></span>
	<a href="<?= base_url().'user/checkout' ?>"  role="button" aria-haspopup="true" aria-expanded="true">
